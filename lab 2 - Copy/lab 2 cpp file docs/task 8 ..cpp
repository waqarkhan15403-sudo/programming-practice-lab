...
#include <iostream>   // Library for input and output and cld preprocessor directive
using namespace std;  // Using standard namespace to do not repeat std again and again
...
int main()
{
    ...
    cout << "\nAddition: " << sum << endl; // \n is use for new line
    cout << "Subtraction: " << sub << endl; // endl is use for end line
