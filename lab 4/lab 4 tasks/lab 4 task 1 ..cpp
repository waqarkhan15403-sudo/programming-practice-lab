...
using namespace std;// use the standard namespace to avoid writing std cout and std cin in all coding

int main() {     // main function where program execution starts and this is the main part
    int day;    // semi colon is use for instruction ending and int is variable day is the name of variable
    ...
    switch(day) { // switch statment to chech the value of the day(switch use for selection of one option from the multiple ones)
        case 1: // case is used as a condition here if day is one 
            cout << "Monday";// when case is one the compiler will dispay monday
            break;          // break is used for exit the switch block and work like endl
        case 2:            // if day is 2
