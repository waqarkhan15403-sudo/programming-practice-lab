...
using namespace std;  // allows us to use cout and cin without having the need to typ std for every cin and cout

int main() {                 // main function execution beggins from here and this is the main part of programming
	
	int a;                                // variable declarartion and a is yhe name of variable
