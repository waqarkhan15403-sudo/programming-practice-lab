...
int main(){                    // the starting point from where the computer begins executing program
	...
	int a;                      // variable declaration and a is the nme of variable
	
	cout<<"enter an integer ";     // prompt for user to input data
	cin>>a;                           // takes data from user and puts it into the variable
	
	if(a>0 && a<100)   /* condition for the program to cheak a number is greater than 0 and less than 100 and && this 
	is called logical and and use for condition
