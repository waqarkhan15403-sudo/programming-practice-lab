...
#include <iostream> // this is cld library of code and also preprocessor directive
using namespace std; //write to save our coding from repetion of std fron evey cin and cout
