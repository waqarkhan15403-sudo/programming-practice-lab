...
#include <iostream>  // #include iostream work like tools in this software and take file fom specific location
...
{ // curly bracket use to write main function inside the curly bracket
