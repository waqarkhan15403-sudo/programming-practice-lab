...
using namespace std;  // Use standard namespace, so we don't need to write std again and again

int main()  // Main programming part and execution starts from here
{
    float celsius, fahrenheit;  // I Declare two floating-point variables
    ...
    fahrenheit = (celsius * 9 / 5) + 32;//* use for multiplication and + and yhis is use for addition
